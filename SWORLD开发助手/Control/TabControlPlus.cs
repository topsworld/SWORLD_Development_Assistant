...
{
    [ToolboxBitmap(typeof(TabControlPlus))]
    /// <summary>
    ...
    public class TabControlPlus : TabControl
    {
        ...
        private Color onSelectedColor1 = Color.FromArgb(255, 250, 236);
        private Color onSelectedColor2 = Color.FromArgb(255, 232, 166);
        private Color offSelectedColor1 = Color.Transparent;
        private Color offSelectedColor2 = Color.Transparent;
        private Color MoveSelectedColor1 = Color.White;
        private Color MoveSelectedColor2 = Color.FromArgb(224, 224, 224);
        private Color BottomLineColor = Color.FromArgb(188, 188, 188);
        private SolidBrush brushFont = new SolidBrush(Color.Black);
        private Color backcolor = Color.FromArgb(52, 72, 104);
        ...
        [DefaultValue(typeof(Color), "255, 250, 236")]
        [Browsable(true)]
        ...
        [DefaultValue(typeof(Color), "255, 232, 166")]
        [Browsable(true)]
        ...
        protected virtual void Draw(Graphics g)
        {
            ...
            using (Bitmap overlay = new Bitmap(rctTabHeaderImage.Width, rctTabHeaderImage.Height))
            {
                ...
                g.DrawLine(new Pen(new SolidBrush(Color.LightGray), 4), 0, 28, this.ClientSize.Width, 28);                    //绘制顶部线条
            }
        }
        ...
        protected virtual void DrawAll(Graphics g, Rectangle rect, string title, bool selected, bool mouseOver)
        {
            try
            {
                rectFont = new Rectangle(rect.X + 6, rect.Y + 4, rect.Width, rect.Height - 6);

                drawRect(g, rect, selected, mouseOver);
                drawString(g, rectFont, title, Font, selected);
        ...
        protected virtual void drawRect(Graphics g, Rectangle rect, bool selected, bool mouseOver)
        {
            using (GraphicsPath path = new GraphicsPath())
            {
                ...
                if (mouseOver)
                {
                    using (LinearGradientBrush brush = new LinearGradientBrush(rect, Color.FromArgb(20, MoveSelectedColor1), Color.FromArgb(100, MoveSelectedColor2), LinearGradientMode.Vertical))
                    {
        ...
        /// <param name="mouseOver"></param>
        protected virtual void drawString(Graphics g, Rectangle rect, string title, Font font, bool bselect)
        {
            if (bselect)
            {
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (this.TabCount > 0)
                {
                    //if (!AllSelected)
                    //{
                    //    Rectangle tabRect = new Rectangle(this.GetTabRect(this.SelectedIndex).X + this.GetTabRect(this.SelectedIndex).Width - 18, 9, 12, 12);
                    ...
                    //else
                    //{
                    //    Rectangle tabRect = new Rectangle(this.GetTabRect(tabid).X + this.GetTabRect(tabid).Width - 18, 9, 12, 12);
        ...
        protected override void OnSelecting(TabControlCancelEventArgs e)
        {
            ...
            if (OverIndex > -1)
            {
                Rectangle tabRect = new Rectangle(this.GetTabRect(e.TabPageIndex).X + this.GetTabRect(e.TabPageIndex).Width, 9, 12, 12);
        ...
        public override Rectangle DisplayRectangle
        {
            get
            {
                ...
                return new Rectangle(rect.Left - 3, rect.Top + 1, rect.Width + 6, rect.Height + 1);
            }
        }
