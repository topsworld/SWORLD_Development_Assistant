    ...
    public partial class Update : Form
    {
        ...
        public int Down_New_Version()
        {
            try
            {
                ...
                {
                    // 下载单个文件
                    reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(Server_URL + Soft_Name + "/" + Soft_Version + "/" + fileName));
                    Show_Msg(string.Format("进度2/3：下载文件【{0}】...", fileName));
                    reqFTP.Credentials = new NetworkCredential();
                    ...
                    outputStream = new FileStream("Update//" + fileName, FileMode.OpenOrCreate);
